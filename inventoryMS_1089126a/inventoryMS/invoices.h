...
namespace inventoryMS {
	...
	/// Summary for invoice
	/// </summary>
	public ref class invoices : public System::Windows::Forms::Form
	{
	public:
		invoices(void)
		{
		...
		invoices(String^ cname, String^ phno, String^ prod, String^ pay, String^ datetime2, String^ datetime3, int quan, int ttl)
		{
			InitializeComponent();
			//
			label6->Text = cname;
			label7->Text = phno;
			label8->Text = prod;
			label9->Text = System::Convert::ToString(quan);
			label13->Text = datetime2;
			label14->Text = pay;
			label15->Text = System::Convert::ToString(ttl);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->print->Click += gcnew System::EventHandler(this, &invoices::print_Click);
			// 
			// invoices
			// 
...
#pragma endregion
	private: System::Void print_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		StreamWriter^ pwriter = gcnew StreamWriter("Output.txt");
		pwriter->Write("Customer Name : -" + label6->Text+" Phone Number :-"+label7->Text+" Product : -"
		+label8->Text+" Quantity :- "+label9->Text +" Total :- "+label15->Text);
		pwriter->Close();
